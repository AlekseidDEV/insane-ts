...
export const galleryPortfolio = () =>{
    ...
    const totalSpan: Span | null = popupGallery!.querySelector('.slider-counter-content__total')
    const curentSpan: Span | null = popupGallery!.querySelector('.slider-counter-content__current')
