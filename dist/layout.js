...
/***/ "./src/modules/renderTableBts.ts":
/*!***************************************!*\
  !*** ./src/modules/renderTableBts.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, exports) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\nexports.renderTableBtns = void 0;\nconst renderTableBtns = (data) => {\n    const uniqueKeyType = new Set();\n    const navBlock = document.querySelector('.nav-list-popup-repair');\n    const renderBtn = (typeArr) => {\n        navBlock.innerHTML = '';\n        for (let i = 0; i <= typeArr.length - 1; i++) {\n            const newBtn = document.createElement('button');\n            if (i === 0) {\n                newBtn.classList.add('button_o', 'popup-repair-types-nav__item', 'active_o');\n                newBtn.textContent = typeArr[i];\n            }\n            else {\n                newBtn.classList.add('button_o', 'popup-repair-types-nav__item');\n                newBtn.textContent = typeArr[i];\n            }\n            navBlock === null || navBlock === void 0 ? void 0 : navBlock.append(newBtn);\n        }\n    };\n    data.forEach((obj) => {\n        uniqueKeyType.add(obj.type);\n    });\n    renderBtn([...uniqueKeyType]);\n};\nexports.renderTableBtns = renderTableBtns;\n\n\n//# sourceURL=webpack://insane-ts/./src/modules/renderTableBts.ts?");
